...
function transmitiendoBatch() {
    ...
    const elementosPorLote = 50;

    // Dividir y mostrar en lotes
    for (let i = 0; i < backup.length; i += elementosPorLote) {
        const lote = backup.slice(i, i + elementosPorLote);
